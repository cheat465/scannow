...
export default function MenuClient({
  ...
  const canOrder = 
    ...
    isWithinOperatingHours(); // Fixed parentheses + added geofencing optional chaining
  ...
  // Show/hide banner based on operating hours
  useEffect(() => {
    if (!isWithinOperatingHours()) {
      setShowGeofenceBanner(true);
    } else {
      // If we are now within operating hours, hide the closed banner (if it was shown for that reason)
      setShowGeofenceBanner(false);
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-32">
      {/* Geofencing & Closed Persistent Alert */}
